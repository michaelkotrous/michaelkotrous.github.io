...
- title: "Principles of Macroeconomics"
  ...
  coverart: /uploads/econ2105/Original_Principles_of_Macroeconomics_Banner_Cropped.png
  coverart_alt: "Banner Image for my Principles of Macroeconomics Course (generated by ChatGPT)"
  card_links:
    - text: Syllabus
      url: /uploads/econ2105/Kotrous_ECON2105_Summer2024_Syllabus.pdf
    - text: Course Evaluations
      url: /uploads/econ2105/Kotrous_ECON2105_Evaluations.pdf
```
...
- type: working paper
  ...
  url: /uploads/research/YourName_PaperSlug.pdf
  date: "Month DD, YYYY"
  coverart: /uploads/research/your-figure.png
  ...
  links:
    - text: Slides
      url: /uploads/research/YourName_PaperSlug_Slides.pdf
    - text: Video
...
| Field | Notes |
|---|---|
| `url` | Link on the paper title; use a relative `/uploads/research/` path for PDFs or a full URL for journal pages |
...
Upload the PDF to `uploads/research/` before pushing.
